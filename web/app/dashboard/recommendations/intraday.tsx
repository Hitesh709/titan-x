...
export function IntradayRecommendations() {
  ...
  return <div className="space-y-5">
    ...
    {loading && <div className="glass-card p-8 text-center text-sm text-gray-400">Starting full-market scan…</div>}
