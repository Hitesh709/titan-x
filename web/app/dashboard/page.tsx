...
import {
  ...
  BarChart3, Users, ArrowUpRight, ArrowDownRight, MoreHorizontal,
  Star, LineChart,
} from "lucide-react"
...
const topMovers = [
  { symbol: "NVDA", name: "NVIDIA Corp", price: 874.32, change: 4.56 },
  { symbol: "AAPL", name: "Apple Inc", price: 187.45, change: -1.23 },
  { symbol: "MSFT", name: "Microsoft Corp", price: 412.67, change: 2.34 },
  { symbol: "TSLA", name: "Tesla Inc", price: 245.89, change: -3.45 },
  { symbol: "AMZN", name: "Amazon.com", price: 178.23, change: 1.56 },
  { symbol: "GOOGL", name: "Alphabet Inc", price: 156.78, change: 0.89 },
]
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="glass-card p-5">
          <h3 className="text-sm font-semibold text-white mb-4 flex items-center gap-2">
            <TrendingUp size={16} className="text-titan-400" /> Top Movers
          </h3>
          <div className="space-y-3">
            {topMovers.map((stock) => (
              <div key={stock.symbol} className="flex items-center justify-between py-2 border-b border-titan-800/20 last:border-0">
                <div>
