  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        bull.position.set(-2.35, isBull ? 0.52 : -0.02, 0); bear.position.set(2.35, isBear ? 0.52 : -0.02, 0)
        bull.rotation.x = isBull ? -0.12 : 0.12; bear.rotation.x = isBear ? -0.12 : 0.12
        arena.add(bull, bear)
