...
_ROUTER_SPECS: tuple[tuple[str, str | None], ...] = (
    ...
    ("market_data_gateway", "router"), ("market_scanner", "router"), ("master_decision", "router"),
    ("microstructure", "router"), ("model_evaluation", "router"), ("model_registry", "router"),
    ("monitoring", "router"), ("news", "news_router"), ("news_nlp", "news_nlp_router"),
    ("news_scanner", "router"), ("nightly_evaluation", "router"), ("opportunity_rejection", "router"),
    ("order", "router"), ("paper_trading", "router"), ("auto_demo_bot", "router"),
    ("pattern_library", "router"), ("pattern_recognition", "pattern_router"), ("pattern_search", "router"),
    ("performance_measurement", "router"), ("portfolio", "portfolio_router"), ("portfolio_optimizer", "router"),
    ("prediction", "router"), ("prediction_audit", "router"), ("preferences", "router"),
