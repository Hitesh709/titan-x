...
_ROUTER_SPECS: tuple[tuple[str, str | None], ...] = (
    ...
    ("paper_trading", "router"), ("auto_demo_bot", "router"), ("pattern_library", "router"),
    ("pattern_recognition", "pattern_router"), ("pattern_search", "router"),
    ("performance_measurement", "router"), ("portfolio", "portfolio_router"),
